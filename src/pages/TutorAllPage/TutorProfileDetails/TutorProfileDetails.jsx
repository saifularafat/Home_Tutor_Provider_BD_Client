            ...
            <div className="bg-blue-100 md:py-10 py-5 px-2 md:px-0">
                ...
                <div className="md:max-w-4xl mx-auto md:px-8 px-3 md:pt-10 pt-4 pb-4 bg-white rounded-xl">
                    ...
                    <div className="text-center md:py-6 py-3">
                        <h2 className="md:text-3xl text-xl font-bold uppercase bg-gradient-to-r from-[#064668] to-[#1e78c2a9] bg-clip-text text-transparent">Mohammad Saiful Islam Arafat </h2>
                    ...
                    <PreferredTutoringClasses_Courses />
                    <PersonalInformation />
