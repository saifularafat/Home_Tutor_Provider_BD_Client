...
const TuitionDetails = () => {
    ...
    return (
        <div className="bg-blue-100 py-10">
            ...
            <div className="max-w-6xl mx-auto px-8 pt-10 pb-4 bg-white rounded-xl">
                ...
                <div className="flex items-center justify-center pt-2">
                    <div className="w-1/2 flex items-start justify-start">
                        <Link to={`/tutor-hire-request/${id}`}>
                            <button className="py-2 px-5 rounded-full text-base tracking-wider font-medium bg-slate-500  hover:bg-slate-600 duration-300 text-white overflow-hidden hover:overflow-visible relative group">
                                Share
                            </button>
                        </Link>
                    </div>
                    <div className="w-1/2 flex items-start justify-start">
                        <Link to={`/tutor-hire-request/${id}`}>
                            <button className="py-2  mx-auto px-6 mb-4 mt-6 rounded-xl text-base tracking-wider font-medium bg-sky-700  hover:bg-sky-600 duration-300 text-white overflow-hidden hover:overflow-visible relative group">
