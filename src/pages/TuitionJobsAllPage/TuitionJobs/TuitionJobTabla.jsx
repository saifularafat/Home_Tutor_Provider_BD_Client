    ...
    return (
        <div className=" w-full">
            ...
            <div className="flex items-center justify-between border-t-[1px] md:px-5 px-2 bg-sky-100 border-slate-300 md:py-2 py-1 rounded-br-md rounded-bl-md">
                <h6 className="font-normal md:tracking-wide text-slate-500 capitalize"> {job?.job?.className}</h6>
                <h6 className="md:font-medium font-normal md:tracking-wide text-[#4B5563] md:uppercase capitalize"> {job?.job?.subject}</h6>
            </div>
