...
const TuitionJobApplyForm = () => {
	...
	const onSubmit = async (data) => {
		...
		const applyData = {
			tutorId: singleTutorFind?.userId || "N/A",
			tutorName: singleTutorFind?.name || "N/A",
			tutorEmail: singleTutorFind?.email || "N/A",
			tutorAddress: singleTutorFind?.address || "N/A",
			tutorDemeanSalary: singleTutorFind?.tutorDemeanSalary || "N/A",
			tutorCurrentLocation: data.applyLocation || "N/A",
			tutorPhone: data.applyContactNumber || "N/A",
			tutorWhatsappNumber: data.applyWhatsAppNumber || "N/A",
			tutorDescription: data.applyInformation || "N/A",
			jobId: tuitionJob?.tuitionCode || "N/A",
			jobEmail: tuitionJob?.userEmail || "N/A",
			jobSubject: tuitionJob?.subject || "N/A",
			jobClass: tuitionJob?.className || "N/A",
			jobMedium: tuitionJob?.medium || "N/A",
			jobCategory: tuitionJob?.jobCategory || "N/A",
			jobSalary: tuitionJob?.jobSalary || "N/A",
			jobPerWeek: tuitionJob?.perWeek || "N/A",
			jobAddress: tuitionJob?.jobLocation || "N/A",
			jobComment: tuitionJob?.jobComment || "N/A",
			jobPhone: tuitionJob?.contactNumber || "N/A",
			jobSchoolName: tuitionJob?.studentSchool || "N/A",
			jobPostDate: tuitionJob?.updatedAt || "N/A",
			jobWhatsappNumber: tuitionJob?.whatsAppNumber || "N/A",
		};
