...
const CourseCard = () => {
    return (
        <>
            ...
            <div className="container mx-auto grid grid-cols-4 gap-5 py-9">
                <div className="mx-auto hover:border-blue-400 hover:shadow-2xl space-y-4 rounded border p-3  dark:border-zinc-700 dark:bg-zinc-900"> */}
            {/* Card Image */}
            {/* <img width={350} height={190} className="h-[190px] w-full rounded-xl bg-gray-400" src={course1} alt="card navigate ui" /> */}
            {/* Card Heading */}
            ...
            {/* <div className="mt-5 flex items-center justify-between">
                        <h2 className="font-medium text-gray-700 md:text-xl dark:text-white/60">৳২০০</h2>
                        <button className="rounded-lg bg-slate-800 px-6 py-2 text-[12px] font-semibold text-white hover:bg-slate-900 sm:text-sm md:text-base">Purchase</button>
                    </div>
                </div>
                <div className="mx-auto hover:border-blue-400 hover:shadow-2xl space-y-4 rounded border p-3  dark:border-zinc-700 dark:bg-zinc-900"> */}
            {/* Card Image */}
            {/* <img width={350} height={190} className="h-[190px] w-full rounded-xl bg-gray-400" src={course3} alt="card navigate ui" /> */}
            {/* Card Heading */}
            {/* <div className="space-y-2">
                        <h2 className="font-medium text-slate-800 sm:text-lg md:text-xl dark:text-white/90">Videos Course</h2>
                        <p className="text-sm font-medium text-slate-600">Mohammad Saiful Arafat</p>
            ...
            {/* <div className="mx-auto hover:border-blue-400 hover:shadow-2xl space-y-4 rounded border p-3  dark:border-zinc-700 dark:bg-zinc-900"> */}
            {/* Card Image */}
            {/* <img width={350} height={190} className="h-[190px] w-full rounded-xl bg-gray-400" src={course2} alt="card navigate ui" /> */}
            {/* Card Heading */}
            {/* <div className="space-y-2">
                        <h2 className="font-medium text-slate-800 sm:text-lg md:text-xl dark:text-white/90">Videos Course</h2>
                        <p className="text-sm font-medium text-slate-600">Mohammad Saiful Arafat</p>
