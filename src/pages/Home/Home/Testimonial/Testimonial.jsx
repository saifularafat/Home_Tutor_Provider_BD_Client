            ...
            <div className="container md:min-w-[350px] mx-auto md:h-[280px] flex flex-row items-center overflow-hidden md:gap-5 gap-3 lg:gap-10 px-6 md:px-6 lg:px-5 md:pb-10 pb-7 md:pt-8 pt-4">
                <div className="relative overflow-hidden">
                    ...
                    <div
                        ...
                        {/* sliders */}
                        {array.map((each, idx) => (
                            <div key={idx} className="md:p-3 p1 min-w-full md:min-w-[50%]">
                                <div className="h-full md:p-8 p-3 rounded shadow-[0px_4px_12px_rgba(0,0,0,0.1)]">
                                    ...
                                    <p className="leading-relaxed md:mb-6 mb-3 text-gray-500">{each?.testimonialDescription}</p>
                                    <a className="inline-flex items-center">
                                        <img className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" src={`https://source.unsplash.com/200x200/?${each.keyWord}`} alt="user photo" />
                                        <span className="flex-grow flex flex-col md:pl-4 pl-3">
                                            <span className="font-medium text-gray-900">{each.name}</span>
