	...
	return (
		<div className="my-5">
			...
			<form
				...
				className="mx-auto md:max-w-6xl w-full border-2 bg-red-400 rounded-xl p-3 md:p-6 shadow-lg"
			>
				<h1 className="md:text-xl text-lg font-semibold my-2 md:my-4 text-center text-slate-700 capitalize">
					up comming....
				</h1>
				<h1 className="md:text-3xl text-xl font-semibold my-2 md:my-4 text-center text-slate-700">
					Create Notice
				</h1>
