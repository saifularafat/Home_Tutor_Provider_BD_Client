...
const TermsAndCondition = () => {
    return (
        <div className="md:my-5 my-3">
            ...
            <div className="w-full mx-auto md:my-8 my-4 px-4 py-6 bg-white rounded-lg">
                <PageTitleShow currentPage="Terms and Condition" />
                <h3 className="text-2xl font-bold text-left pb-5">Home Tutor Provider <sup>BD</sup></h3>
                <div>
